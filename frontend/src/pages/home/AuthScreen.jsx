    ...
    <div className='hero-bg relative'>
      ...
      <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
        <h1 className='text-4xl md:text-6xl font-bold mb-4'>
          Peliculas ilimitadas, TV shows, y más
        </h1>
        <p className='text-lg mb-4'>
          Mira donde quieras. Cancela cuando quieras.
        </p>
        <p className='mb-4'>
          Listo para disfrutar? Ingresa tu correo para restaurar o crear tu
          membresia.
        </p>
      ...
      <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
          ...
          <div className='flex-1 text-center md:text-left'>
            ...
            <p className='text-lg md:text-xl'>
              Disfruta de películas y series ilimitadas en tu teléfono, tableta,
              laptop y TV.
            </p>
          </div>
      ...
      <div className='py-10 bg-black text-white'>
        ...
        >
          ...
          <div className='flex-1 text-center md:text-left'>
            ...
            <p className='text-lg md:text-xl'>
              Lleva a los niños a aventuras con sus personajes favoritos en un
              espacio diseñado solo para ellos, gratis con tu membresía.
            </p>
          </div>
        </div>
      </div>
